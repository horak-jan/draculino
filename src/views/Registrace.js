    ...
    <div className="registrace">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <input
          ...
          ref={register({ required: "Toto pole je nutné vyplnit." })}
        />
        {errors.rc && <p className="form-error">{errors.rc.message}</p>}
        ...
        {/* reason why to start */}
        <label htmlFor="why">Důvod/cíl proč chceš začít s tréninkem?</label>
        ...
        {/* cash /multisport */}
        <label htmlFor="multisport">Platba Multisportkou?</label>
        <input type="checkbox" name="multisport" ref={register} />
        ...
        <p>
          Uvedené údaje budou použity pouze pro účely Draculino k informování o
          vámi vybraném kurzu. Nebudou Vám zasílány žádné newslettery. Členem
          spolku GB Draculino se stáváte až po zaplacení kurzovného.
        </p>
        <p className="last-p">
          V případě, že nechcete vyplnit tuto přihlášku, kontaktujte nás
          telefonicky na čísle +420 724 711 515.
        </p>
